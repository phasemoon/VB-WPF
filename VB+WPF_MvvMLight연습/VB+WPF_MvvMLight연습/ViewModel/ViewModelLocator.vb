...
Namespace ViewModel
    ...
    Public Class ViewModelLocator
        ...
        Public ReadOnly Property SenderViewModel As SenderViewModel
            Get
                Return ServiceLocator.Current.GetInstance(Of SenderViewModel)()
            End Get
        End Property

        Public ReadOnly Property ReceiverViewModel As ReceiverViewModel
            Get
                Return ServiceLocator.Current.GetInstance(Of ReceiverViewModel)()
            End Get
        End Property
